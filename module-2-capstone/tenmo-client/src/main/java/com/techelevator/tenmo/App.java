...
public class App {
    ...
    private AccountService currentUserAccount = new AccountService();
    private final TransferService transferService = new TransferService(API_BASE_URL, currentUserAccount);
	...
	private BigDecimal viewCurrentBalance() {
        ...
        //Make sure this see the account balance
        try{
            balance = currentUserAccount.getAccountBalance(currentUser);
